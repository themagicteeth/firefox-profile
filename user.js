...
user_pref("browser.onboarding.state", "off");
...
// Devtools
user_pref("devtools.debugger.features.event-listeners", true);
user_pref("devtools.debugger.ignore-caught-exceptions", false);
user_pref("devtools.flexboxinspector.enabled", true);
...
user_pref("devtools.inspector.flexboxHighlighter.enabled", true);
user_pref("devtools.inspector.fonteditor.enabled", true);
user_pref("devtools.inspector.fonthighlighter.enabled", true);
user_pref("devtools.inspector.show-three-pane-tooltip", false);
user_pref("devtools.inspector.show_pseudo_elements", true);
user_pref("devtools.performance.ui.enable-memory", true);
user_pref("devtools.performance.ui.enable-memory-flame", true);
...
user_pref("extensions.formautofill.supportRTL", false);
